...
_C.model.transformer.output_dim = [256, 128, 128, 128]
_C.model.transformer.input_dim = [512, 256, 128, 128]
_C.model.transformer.num_heads = 4
_C.model.transformer.num_queries = 64
_C.model.transformer.img_radius_thresold = [128, 64, 32, 16]
_C.model.transformer.pcd_radius_thresold = [None, 16, 8, 4]
