...
src_folder_path = "/data/user/rencw/ICL-I2PReg/views_tube"
dst_folder = "/data/user/rencw/ICL-I2PReg/dst_folder_tube"
...
for src_folder_path, dst_folder_path in zip(src_folder_path_list, dst_folder_path_list):
    idx_list = range(0, 12)
